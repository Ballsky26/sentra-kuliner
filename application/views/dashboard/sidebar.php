                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle" href="#" id="messagesDropdown" role="button"
                                ...
                                <span class="badge badge-danger badge-counter"><?php echo $jumlah_pendaftar; ?></span>
                            </a>
                            <!-- Dropdown - Messages -->
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <h6 class="dropdown-header">
                                    Pendaftar Baru (<?php echo $jumlah_pendaftar; ?>)
                                </h6>
                                    <?php foreach ($pendaftar as $pendaftar) : ?>
                                <a href="<?= base_url(); ?>pendaftar/pengajuan/<?= $pendaftar->id?>" class="dropdown-item d-flex align-items-center">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="<?= base_url('uploads/foto/profil/') . $pendaftar->fotoprofil; ?>"
                                            alt="...">
                                    </div>
                                    <div>
                                        <div class="text-truncate"><?= $pendaftar->nama; ?></div>
                                        <div class="small text-gray-500"><?= $pendaftar->telpon; ?> - <?= date('d M Y H:i:s', $pendaftar->tgldaftar); ?></div>
                                    </div>
                                </a>
                                    <?php endforeach; ?>
                                <a class="dropdown-item text-center small text-gray-500" href="<?= base_url('/pendaftar');?>">Lihat Semua Pendaftar</a>
                            </div>
                        </li>
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle" href="#" id="messagesDropdown" role="button"
                                ...
                                <!-- Counter - Messages -->
                                <?php $jumlah_pesan = $this->model_kontak->tampil_pesan('pesan')->num_rows(); ?>
                                <span class="badge badge-danger badge-counter"><?php echo $jumlah_pesan; ?></span>
                            </a>
                            <!-- Dropdown - Messages -->
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                aria-labelledby="messagesDropdown">
                                <h6 class="dropdown-header">
                                    Pesan Masuk (<?php echo $jumlah_pesan; ?>)
                                </h6>
                                    <?php foreach ($pesan as $pesan) : ?>
                                <a href="<?= base_url(); ?>pesan/detail_pesan/<?= $pesan->id?>" class="dropdown-item d-flex align-items-center">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="<?php echo base_url() ?>assets/img/undraw_profile_2.svg"
                                            alt="...">
                                    </div>
                                    <div>
                                        <div class="text-truncate"><?= $pesan->isipesan; ?></div>
                                        <div class="small text-gray-500"><?= $pesan->nama; ?> - <?= date('d M Y H:i:s', $pesan->date_sent); ?></div>
                                    </div>
                                </a>
                                    <?php endforeach; ?>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="<?= base_url(); ?>dashboard/editprofil/">
